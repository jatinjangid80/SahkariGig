...
export const HowItWorksView: React.FC<HowItWorksViewProps> = ({
  ...
  return (
    <div className="py-12 sm:py-16 bg-[#F8FAFC] min-h-[calc(100vh-68px)] font-sans">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <h1 className="text-3xl sm:text-5xl font-black text-[#0F172A] tracking-tight font-outfit">
        ...
        {/* 2. Interactive Steps & Dynamic Mockup */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-6">
            <div className="bg-[#0F172A] rounded-3xl p-2 shadow-xl border border-slate-800 text-white">
        ...
        {/* 3. Bottom CTA Banner */}
        <div className="p-8 sm:p-10 rounded-3xl bg-gradient-to-r from-[#166534] to-[#0F766E] text-white flex flex-col sm:flex-row items-center justify-between gap-6 shadow-lg">
          ...
          <div className="flex flex-wrap items-center gap-3 shrink-0">
            <button
              type="button"
              onClick={() => {
                if (onNavigate) onNavigate('/workers');
              }}
