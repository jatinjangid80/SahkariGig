...
export const AuthModal: React.FC<AuthModalProps> = ({ 
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const userRole = (email.includes('worker') || selectedRole === 'Worker') ? 'Worker' : selectedRole;
      const demoUser = {
      ...
      <div className="bg-white w-full max-w-md rounded-2xl shadow-2xl border border-slate-200 overflow-hidden relative">
        ...
        <div className="p-6 space-y-5">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* Account Type / Role Selection (Available for both Sign In & Sign Up) */}
            <div>
                ...
                <button
                  ...
                  className={`p-2.5 rounded-xl border text-xs font-semibold transition-all ${
                    selectedRole === 'Customer'
                      ? 'border-emerald-600 bg-emerald-50 text-emerald-800 shadow-2xs font-bold'
